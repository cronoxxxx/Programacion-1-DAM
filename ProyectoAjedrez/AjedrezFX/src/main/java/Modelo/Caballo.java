...
public class Caballo extends Pieza {
    ...
    public Image toImage() {
        ...
        if (Caballo.super.getColor().equals("negro"))
            image = new Image("File:src/main/resources/com/example/imagenes/CaballoNegro.png");
        else
            image = new Image("File:src/main/resources/com/example/imagenes/CaballoBlanco.png");
        return image;
    }
