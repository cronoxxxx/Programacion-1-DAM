...
public class Torre extends Pieza {
    ...
    public Image toImage() {
        ...
        if (Torre.super.getColor().equals("negro"))
            image = new Image("File:src/main/resources/com/example/imagenes/TorreNegra.png");
        else
            image = new Image("File:src/main/resources/com/example/imagenes/TorreBlanca.png");
        return image;
    }
