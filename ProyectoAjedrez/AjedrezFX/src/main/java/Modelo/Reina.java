...
public class Reina extends Pieza {
    ...
    public Image toImage() {
        ...
        if (Reina.super.getColor().equals("negro"))
            image = new Image("File:src/main/resources/com/example/imagenes/ReinaNegra.png");
        else
            image = new Image("File:src/main/resources/com/example/imagenes/ReinaBlanca.png");
        return image;
    }
