...
public class Alfil extends Pieza {
    ...
    public Image toImage() {
        ...
        if (Alfil.super.getColor().equals("negro"))
            image = new Image("File:src/main/resources/com/example/imagenes/AlfilNegro.png");
        else
            image = new Image("File:src/main/resources/com/example/imagenes/AlfilBlanco.png");
        return image;
    }
