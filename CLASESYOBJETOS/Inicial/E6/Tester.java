...
public class Tester {
    ...
    private static void crearMenu (){
        ...
        Persona titular;
        Coche nuevo;
        double precio, impuestoMatriculacion;
        int km,numPlaza;
        do {
            System.out.println("Bienvenido al garaje, selecciona una opcion\n" +
                    "1. Construye plaza (Crea plaza vacia)\n" +
                    "2. Alquilar pieza (Poner un coche)\n" +
                    "3. Asignar un coste (Poner un precio)\n" +
                    "4. Ver los precios de todas las plazas\n" +
                    "5. Ver la plaza mas barata\n");
            System.out.println("Ingrese una opcion: ");
            opcion= entrada.nextInt();
            switch (opcion){
                case 1:
                    garaje.construyePlazas();
                    break;
                case 2:
                    entrada.nextLine();
                    ...
                    titular=new Persona(nombre,DNI);
                    System.out.println("Ingrese el precio: ");
                    precio= entrada.nextDouble();
                    System.out.println("Ingrese el impuesto de Matriculacion: ");
                    impuestoMatriculacion= entrada.nextDouble();
                    System.out.println("Su kilometraje: ");
                    km= entrada.nextInt();
                    nuevo=new Coche(matricula,titular,precio,impuestoMatriculacion,km);
                    System.out.println("Ingrese el numero de plaza a asignar: ");
                    numPlaza= entrada.nextInt();
                    garaje.alquilarPlaza(nuevo,numPlaza);
                    break;
                case 3:break;
                case 4:break;
                case 5:break;
