...
public class SkiAlpino extends Pista {
    ...
    public SkiAlpino(int id, String nombre, String provincia, double kmExtension, String dificultade) throws DificultadException {
        super(id, nombre, provincia, kmExtension);
        Comprobacion.dificultadOK(dificultade);
        this.dificultad = dificultade;
    }
    ...
    public String toStringFile() {
        return super.toStringFile() +";"+dificultad;
    }
}
